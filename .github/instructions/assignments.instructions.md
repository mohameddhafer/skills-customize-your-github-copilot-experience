...
IMPORTANT!!!
Do not include extra sections unless explicitly specified (should follow sections in the template). Avoid adding any additional information that is not directly related to the assignment tasks.
Follow the same structure and formatting as the template in in [`templates/assignment-template.md`](../../templates/assignment-template.md) to maintain consistency across all assignments.
All text should be in english. Avoid using technical jargon without explanation. The language should be clear and accessible to beginners. 